...
<body ng-app="login">
  ...
  <div class="container-fluid" ng-controller="login-ctrl">
    <div class="row" id="signin-form">
      <form class="col-sm-3" id="form" name="frmLogin">
        ...
        <button type="submit" class="btn btn-secondary rounded-pill" id="btnLogin" ng-show="frmLogin.$valid" ng-click='handle()' ">
          {{buttonName}}
        </button>

        <button type="submit" class="btn btn-secondary rounded-pill" id="btnLogin" ng-hide="frmLogin.$valid">
          {{buttonName}}
        </button>
      ...
      <div class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
          <form class="modal-content p-3" name="form">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" ng-hide="form.emailuser.$valid">Submit</button>
              <button class="btn btn-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal"
                data-bs-dismiss="modal" ng-show="form.emailuser.$valid">Submit</button>
            </div>
          </form>
        </div>
      </div>
      <div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2"
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalToggleLabel2">Successfull !</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              Please check email to receive a temporary password.
            </div>
            <div class="modal-footer">
